...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Reproducible-Research/PA1_template.Rmd at master · shainadel/Reproducible-Research · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="4FB4A882:0553:1384D9D1:55AC0721" name="octolytics-dimension-request_id" />
...
<meta content="JAqvGwoZmDvnRWoJWbNUbfrysBhcd9pfVbn+lxrbcL2W5e8EHjyaprAzbEJka53eHGLlF8qvqhLbIeC0ELRRmg==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fshainadel%2FReproducible-Research%2Fblob%2Fmaster%2FPA1_template.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<div class="clone-options">You can clone with
  <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="2gJ60AHJ3un3vBkw9N3cG1w+3n62SBub8RXZSBxn6G3jp3ll9I7k4QRuPI99IOxhhANMCOqOCjOngh9ugSRNHA==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="tsIvDht0AxpUSs2xB0UMbFG/9aDUUgVXULVIaHMSti0bEapQKQcuS4s/Da4dJNdq6ODOMU5dz9WCCYO5SJB/bw==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
...
<a href="/shainadel/Reproducible-Research/blob/02b9ed8d52dd30fbdefa600fd5df711e0d257a0f/PA1_template.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:52ad7fc12b187aab1796f1a50194dd22 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/shainadel/Reproducible-Research/blob/master/PA1_template.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/shainadel/Reproducible-Research/contributors/master/PA1_template.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/shainadel/Reproducible-Research/raw/master/PA1_template.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/shainadel/Reproducible-Research/blame/master/PA1_template.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/shainadel/Reproducible-Research/commits/master/PA1_template.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<pre lang="r,"><code>hist(daily_steps, col = "RED", xlab = "Number of steps per day", main = "Daily Steps")
</code></pre>
...
<p>There are <code>r missing_steps</code> missing values in the "steps" column, <code>r missing_dates</code> missing values in the "dates" column and <code>r missing_intervals</code> missing values in the "intervals" column.</p>
...
<span class="pl-smi">xp_amd</span> <span class="pl-k">&lt;-</span> cbind(<span class="pl-smi">filled_amd</span>, <span class="pl-smi">weekend_day</span>)
</pre></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.05293s from github-fe130-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
